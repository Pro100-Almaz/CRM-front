  ...
  <div class="w-lg-500px p-10 border rounded-2 shadow-sm">
    ...
    <VForm class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" @submit="onSubmitForgotPassword"
      ...
      <div class="text-center mb-10">
        <!--begin::Title-->
        <h1 class="text-gray-900 mb-3">Забыли пароль?</h1>
        <!--end::Title-->

        <!--begin::Link-->
        <div class="text-gray-500 fw-semibold fs-4">
          Для восстановления пароля <br> необходимо ввести ваш email
        </div>
        <!--end::Link-->
      </div>
      <!--begin::Heading-->
      ...
      <div class="fv-row mb-10">
        ...
        <Field class="form-control form-control-solid" v-model="email" type="email" placeholder="" name="email" autocomplete="off" />
